...
> ⚠️ **已废弃（2026-06-22）**：本文是旧版后台填充 / 字段映射方案的历史记录。
> 当前 51guapi 不再填充发帖页、不维护字段映射、不执行发布动作；保留本文仅用于追溯旧实现背景。
> 当前流程请以 `docs/install-and-usage.md`、`docs/ops-runbook.md` 和 `docs/ops/release-checklist.md` 为准。
