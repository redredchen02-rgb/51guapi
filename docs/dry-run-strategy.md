...
> ⚠️ **已废弃（2026-06-22）**：本文记录旧版批量发布机器的 dry-run 设计。
> 当前版本已拆除填充、批量批准、authorized 真发与 dry-run 报告链路。
> 当前产品只支持抓取、AI 提炼、人工预览/编辑、导出 JSON / Markdown；操作说明见 `docs/install-and-usage.md`。
