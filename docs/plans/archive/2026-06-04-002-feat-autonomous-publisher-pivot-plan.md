...
把 51guapi 从「只填充、人逐条点发布」的扩展,改造成「**自家站点的自主发布器**」:
...
- 前序计划:`docs/plans/2026-06-03-001-feat-51guapi-extension-plan.md`(零提交实现地图)、`docs/plans/2026-06-04-001-feat-iteration-e2e-testing-plan.md`(e2e + 真 Quill)
