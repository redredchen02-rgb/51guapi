	...
	return (
		<div className="space-y-4">
			<div className="space-y-1">
				<p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">標題</p>
				<p className="text-lg font-semibold text-foreground">{draft.title}</p>
			</div>
			{draft.subtitle && (
				<div className="space-y-1">
					<p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">副標</p>
					<p className="text-sm text-muted-foreground">{draft.subtitle}</p>
				</div>
			)}
			<div className="space-y-1">
				<p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">正文</p>
